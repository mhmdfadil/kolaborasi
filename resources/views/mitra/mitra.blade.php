...
@section('title', 'Identitas Mitra')

@section('content')
<div class="container py-4">
    @php
        $amitraCount = \App\Models\Organisasi::where('user_id', $user->id)->count();
@endphp
    ...
    <div class="modal fade" id="addMitraModal" tabindex="-1" aria-labelledby="addMitraModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('store-mitram') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="user_nama" value="{{ $user->nama }}" readonly>
...
<div class="modal fade" id="editMitraModal{{ $mitra->id }}" tabindex="-1" aria-labelledby="editMitraModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ route('update-mitram', $mitra->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="modal-body">
                    <!-- Form input untuk nama -->
