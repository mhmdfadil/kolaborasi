...
<div class="modal fade" id="addKerjasamaModal" tabindex="-1" aria-labelledby="addKerjasamaModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <!-- Form Modal -->
            <form action="{{ route('store-kerjasamam') }}" method="POST" enctype="multipart/form-data">
                @csrf
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body" style="background-color: #fff8e1;">
                    ...
                    <!-- Organisation ID -->
                    <div class="mb-3">
                        <strong>Organisasi:</strong> {{ $kerjasama->organisation->name ?? 'Tidak Ada' }}
                    </div>
    ...
    <div class="modal fade" id="editKerjasamaModal{{ $kerjasama->id }}" tabindex="-1" aria-labelledby="editKerjasamaModalLabel{{ $kerjasama->id }}" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('update-kerjasamam', $kerjasama->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="modal-body" style="background-color: #fff8e1;">
                        <div class="mb-3">
