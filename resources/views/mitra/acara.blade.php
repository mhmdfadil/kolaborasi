    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header justify-content-center align-items-center text-center" style="background-color: #006400; color: white;">
                <h5 class="modal-title" id="addAcaraModalLabel"><strong>Tambah Event</strong></h5>
            </div>
            <!-- Form Modal -->
            <form action="{{ route('store-acaram') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <!-- Input partnership_id -->
                    <div class="mb-3">
                        <label for="partnership_id" class="form-label">Partnership</label>
                    ...
                    <!-- Input event_details -->
                    <div class="mb-3">
                        <label for="event_details" class="form-label">Detail Event</label>
...
<div class="modal fade" id="editModal{{ $event->id }}" tabindex="-1" aria-labelledby="editModalLabel{{ $event->id }}" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header justify-content-center align-items-center text-center" style="background-color: #006400; color: white;">
                <h5 class="modal-title" id="editModalLabel{{ $event->id }}"><strong>Ubah Event</strong></h5>
            </div>
            <!-- Form Modal -->
            <form action="{{ route('update-acaram', $event->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="modal-body">
                    <!-- Input partnership_id -->
                    <div class="mb-3">
                        <label for="partnership_id_{{ $event->id }}" class="form-label">Partnership</label>
